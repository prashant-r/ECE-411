echo "--- Executing initialization force file for ../testcode/mp2finaltest.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2finaltest.asm program code."
run 5
...
run 5
echo "Done loading ../testcode/mp2finaltest.asm program code."
