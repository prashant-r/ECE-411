echo "--- Executing initialization force file for ../testcode/mp2factorial.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2factorial.asm program code."
run 5
change /mp2_cpu/dram/vhdl_memory/mem(0) X"0C"
change /mp2_cpu/dram/vhdl_memory/mem(1) X"62"
change /mp2_cpu/dram/vhdl_memory/mem(2) X"0D"
...
change /mp2_cpu/dram/vhdl_memory/mem(16) X"0E"
...
change /mp2_cpu/dram/vhdl_memory/mem(22) X"FF"
change /mp2_cpu/dram/vhdl_memory/mem(23) X"0F"
change /mp2_cpu/dram/vhdl_memory/mem(24) X"05"
...
run 5
echo "Done loading ../testcode/mp2factorial.asm program code."
